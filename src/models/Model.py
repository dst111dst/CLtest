...
import src.models.Graph as graph_op
...
class VanillaSearch(nn.Module):
    ...
    def forward(self, users, items, query_words,
        ...
        if mode == 'output_embedding':
            ...
            return item_embed
        # We use sentence encoding modules to encode query.
...
class GraphSearch(MFSearch):
    def __init__(self, adj_mat,
        ...
        self.sym_mat = self.init_graph(adj_mat)

    def init_graph(self, adj_mat: sp.coo_matrix):
