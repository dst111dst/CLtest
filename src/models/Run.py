...
def run(model_name: str, args):
    ...
    users, item_map, query_max_length,attribute_max_len = AmazonDataset.init(full_df)
    ...
    test_dataset    = AmazonDataset(test_df, users, item_map,
                                    len(word_dict), query_max_length, args.max_sent_len,attribute_max_len,
                                    'test', args.debug, train_dataset.userBuy)
    ...
    if model_name == 'VanillaSearch':
        ...
        model = GraphSearch(train_dataset.adjMatrix,
